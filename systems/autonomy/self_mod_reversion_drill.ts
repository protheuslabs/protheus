...
function loadPolicy(policyPath = DEFAULT_POLICY_PATH) {
  ...
  return {
    ...
    latest_state_paths: {
      gated_self_improvement_policy_path: resolvePath(
        latestState.gated_self_improvement_policy_path || base.latest_state_paths.gated_self_improvement_policy_path,
        base.latest_state_paths.gated_self_improvement_policy_path
      )
    },
    outputs: {
...
function discoverLatestProposalId(policy: AnyObj) {
