...
function runPolicyRootAuthorize({ scope, target, leaseToken, approvalNote, source }: AnyObj = {}): AnyObj {
  const args = [
    POLICY_ROOT_SCRIPT,
    'authorize',
...
function policyRootDecision(input: AnyObj = {}, runner = runPolicyRootAuthorize): AnyObj {
