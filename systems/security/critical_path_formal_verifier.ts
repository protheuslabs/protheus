...
function defaultPolicy() {
  return {
    ...
    state_path: 'state/security/critical_path_formal/latest.json',
    history_path: 'state/security/critical_path_formal/history.jsonl'
  };
}
...
function runVerifier() {
  ...
  addCheck(
    ...
    invIds.has('merge_guard_profile_compat_hook'),
