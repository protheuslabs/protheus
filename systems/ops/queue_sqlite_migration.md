...
1. Set `sqlite.enabled=false` in `config/backlog_queue_executor_policy.json`.
...
- `node memory/tools/tests/backlog_queue_executor.test.js`
- `node memory/tools/tests/backlog_queue_executor_sqlite_concurrency.test.js`
- `node systems/ops/backlog_queue_executor.js run --all=1 --strict=1`
- `node systems/ops/backlog_queue_executor.js status`
