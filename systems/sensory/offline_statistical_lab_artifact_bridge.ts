...
/**
 * Runtime lane for SYSTEMS-SENSORY-OFFLINE-STATISTICAL-LAB-ARTIFACT-BRIDGE.
...
const lane = createLaneModule('SYSTEMS-SENSORY-OFFLINE-STATISTICAL-LAB-ARTIFACT-BRIDGE', ROOT);
