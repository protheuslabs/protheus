...
/**
 * Runtime lane for SYSTEMS-ASSIMILATION-GENERATIVE-META-MODEL-PRIMITIVE.
...
const lane = createLaneModule('SYSTEMS-ASSIMILATION-GENERATIVE-META-MODEL-PRIMITIVE', ROOT);
