...
/**
 * Runtime lane for SYSTEMS-ASSIMILATION-TEST-TIME-MEMORY-EVOLUTION-PRIMITIVE.
...
const lane = createConduitLaneModule('SYSTEMS-ASSIMILATION-TEST-TIME-MEMORY-EVOLUTION-PRIMITIVE', ROOT);
