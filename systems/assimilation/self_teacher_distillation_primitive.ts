...
/**
 * Runtime lane for SYSTEMS-ASSIMILATION-SELF-TEACHER-DISTILLATION-PRIMITIVE.
...
const lane = createLaneModule('SYSTEMS-ASSIMILATION-SELF-TEACHER-DISTILLATION-PRIMITIVE', ROOT);
