...
`systems/assimilation/world_model_freshness.ts` implements `V3-060`.
...
- `node systems/assimilation/world_model_freshness.js run [--apply=1|0] [--strict=1|0] [--max-profiles=N]`
- `node systems/assimilation/world_model_freshness.js status`
