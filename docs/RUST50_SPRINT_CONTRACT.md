...
`systems/ops/rust50_sprint_contract.ts` enforces sprint-mode execution for `V6-RUST50-CONF-002`.
...
## Commands
```bash
node systems/ops/rust50_sprint_contract.js run \
...
node systems/ops/rust50_sprint_contract.js status
```
