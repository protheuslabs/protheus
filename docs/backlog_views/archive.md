...
| V3-RACE-220 | primitive-upgrade | V3 | done | WASI2 Execution Completeness Gate (TS Lane -> WASM Runtime) | V3-RACE-021, V3-RACE-138, V3-RACE-185 |
...
| V3-RACE-230 | extension | V3 | done | Type-Derived Lane Docs Autogeneration (`typedoc` + `cargo-doc`) | V3-RACE-115, V3-RACE-121, V3-RACE-215 |
...
| V3-RACE-260 | hardening | V3 | done | Apple On-Device-First Sovereignty Gate (PCC-Only Cloud Exception) | V3-RACE-255, V3-RACE-214, V3-RACE-017 |
| V3-RACE-261 | hardening | V3 | done | Apple Release Security Gate (App Sandbox/TCC + Notarization/Gatekeeper + Privacy Manifest) | V3-RACE-258, V3-RACE-257, V3-RACE-214 |
...
| V3-RACE-288 | hardening | V3 | done | NVIDIA AI Enterprise Certification Readiness Lane | V3-RACE-279, V3-RACE-278, V3-RACE-245 |
...
| V3-RACE-332 | hardening | V3 | done | OSTree/rpm-ostree Signed Image + Atomic Rollback Lane | V3-RACE-331, V3-RACE-228, V3-RACE-120 |
...
| V3-RACE-334 | primitive-upgrade | V3 | done | Linux Kernel Acceleration/Sandbox Primitive Lane (eBPF/io_uring/cgroupv2/Landlock) | V3-RACE-220, V3-RACE-333, V3-RACE-174 |
