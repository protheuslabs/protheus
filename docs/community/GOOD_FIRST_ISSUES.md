...
- Area: `area/conduit`
- Acceptance:
  - Add `docs/conduit/message_examples/*.json` samples for command/event types.
...
- Area: `area/docs`
- Acceptance:
  - Add “Common Failures” section to `docs/GETTING_STARTED.md`.
...
- Area: `area/security`
- Acceptance:
  - Add `owner` field per layer in `config/security_layer_inventory.json`.
...
- Acceptance:
  ...
  - Document usage in `deploy/terraform/protheus_helm/README.md`.
...
- Area: `area/community`
- Acceptance:
  - Add simple markdown lint/consistency check for `docs/announcements/`.
