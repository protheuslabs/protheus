...
|---|---|---|---|
| `source_of_truth` | tracked | `client/runtime/systems/**`, `client/runtime/lib/**`, `client/runtime/config/**`, `docs/client/**`, `tests/tooling/scripts/memory/**` | Canonical implementation, policies, and operator docs stay reviewable in git history. |
