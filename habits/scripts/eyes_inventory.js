 ...
 *
 * Usage:
 *   node habits/scripts/eyes_inventory.js
 *   node habits/scripts/eyes_inventory.js --json
 *   node habits/scripts/eyes_inventory.js --help
 */
...
function usage() {
  console.log('Usage:');
  console.log('  node habits/scripts/eyes_inventory.js');
  console.log('  node habits/scripts/eyes_inventory.js --json');
  console.log('  node habits/scripts/eyes_inventory.js --help');
  console.log('');
