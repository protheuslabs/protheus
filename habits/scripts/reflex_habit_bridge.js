 ...
 *
 * Usage:
 *   node habits/scripts/reflex_habit_bridge.js sync [--apply=1]
 *   node habits/scripts/reflex_habit_bridge.js gc [--apply=1]
 *   node habits/scripts/reflex_habit_bridge.js status
 *   node habits/scripts/reflex_habit_bridge.js --help
 */
...
function usage() {
  console.log('Usage:');
  console.log('  node habits/scripts/reflex_habit_bridge.js sync [--apply=1]');
  console.log('  node habits/scripts/reflex_habit_bridge.js gc [--apply=1]');
  console.log('  node habits/scripts/reflex_habit_bridge.js status');
}
