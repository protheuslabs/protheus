...
node "$ROOT_DIR/systems/ops/mobile_wrapper_distribution_pack.js" verify --owner="${PROTHEUS_OWNER:-jay}" --target=ios_tauri --policy="$ROOT_DIR/config/mobile_wrapper_distribution_pack_policy.json" --strict=1 --apply=0
