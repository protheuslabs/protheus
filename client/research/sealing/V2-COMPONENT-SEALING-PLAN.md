...
- client/systems/redteam/ant_colony_controller.js
...
Add hashes to: `client/config/security_integrity_policy.json`
...
After sealing:
1. Run integrity check: `node client/systems/security/integrity_kernel.js check`
...
- `client/config/helix_policy.json`: shadow_only → false
- `client/config/echo_policy.json`: shadow_only → false, allow_apply → true
- `client/config/weaver_policy.json`: shadow_only → false
