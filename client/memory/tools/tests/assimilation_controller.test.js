...
function basePolicy() {
  return {
    ...
    integration: {
      ...
      memory_evolution_policy_path: 'client/config/memory_evolution_primitive_policy.json',
      context_navigation_policy_path: 'client/config/context_navigation_primitive_policy.json',
      generative_simulation_policy_path: 'client/config/generative_simulation_mode_policy.json',
      collective_reasoning_policy_path: 'client/config/collective_reasoning_primitive_policy.json',
      environment_evolution_policy_path: 'client/config/environment_evolution_layer_policy.json',
      test_time_memory_evolution_policy_path: 'client/config/test_time_memory_evolution_primitive_policy.json',
      group_evolving_agents_policy_path: 'client/config/group_evolving_agents_primitive_policy.json',
      generative_meta_model_policy_path: 'client/config/generative_meta_model_primitive_policy.json',
      self_teacher_distillation_policy_path: 'client/config/self_teacher_distillation_primitive_policy.json',
      adaptive_ensemble_routing_policy_path: 'client/config/adaptive_ensemble_routing_primitive_policy.json',
