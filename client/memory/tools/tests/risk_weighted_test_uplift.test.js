...
const LANE_RULES = [
  {
    ...
    minFiles: 2,
    files: [
      'client/memory/tools/tests/proposal_queue.test.js',
      'client/memory/tools/tests/directive_gate.test.js',
      'client/memory/tools/tests/autonomy_policy_hold_classification.test.js'
    ],
  ...
  },
  {
    ...
    minFiles: 2,
    files: [
      'client/memory/tools/tests/mutation_safety_kernel.test.js',
      'client/memory/tools/tests/quorum_validator.test.js',
      'client/memory/tools/tests/improvement_controller_two_phase.test.js'
    ],
  ...
  },
  {
    ...
    minFiles: 2,
    files: [
      'client/memory/tools/tests/autonomy_actionability_rollback_guard.test.js',
      'client/memory/tools/tests/improvement_controller_two_phase.test.js',
  ...
  },
  {
    ...
    minFiles: 2,
    files: [
      'client/memory/tools/tests/emergency_stop.test.js',
      'client/memory/tools/tests/emergency_stop_cli.test.js',
      'client/memory/tools/tests/route_task_emergency_stop.test.js'
    ],
  ...
  },
  {
    ...
    files: [
      ...
      'client/memory/tools/tests/strategy_mode_governor_policy_root.test.js',
