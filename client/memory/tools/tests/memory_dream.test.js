...
function run() {
  ...
  writeJsonl(path.join(pointersDir, '2026-02-20.jsonl'), [
    {
      ...
      memory_file: 'client/memory/2026-02-20.md'
    },
    {
      date: '2026-02-20',
  ...
  writeJsonl(path.join(pointersDir, `${dateStr}.jsonl`), [
    {
      ...
      memory_file: 'client/memory/2026-02-21.md'
    }
  ]);
  ...
  writeJsonl(path.join(failurePointersDir, `${dateStr}.jsonl`), [
    {
      ...
      memory_file: `client/memory/${dateStr}.md`,
  ...
  assert.ok(md.includes('client/memory/2026-02-20.md#eye-hn-aaa11111') || md.includes('client/memory/2026-02-20.md#eye-molt-bbb22222'));
