...
// Layer ownership: core/layer1/security::mcp-a2a-venom-contract-gate (authoritative)
...
const SECURITY_CMD = 'mcp-a2a-venom-contract-gate';
const bridge = createOpsLaneBridge(__dirname, 'mcp_a2a_venom_contract_gate', 'security-plane');
