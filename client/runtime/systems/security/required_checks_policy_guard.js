...
// Layer ownership: core/layer1/security::required-checks-policy-guard (authoritative)
...
const SECURITY_CMD = 'required-checks-policy-guard';
const bridge = createOpsLaneBridge(__dirname, 'required_checks_policy_guard', 'security-plane');
