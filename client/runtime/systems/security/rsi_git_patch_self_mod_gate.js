...
// Layer ownership: core/layer1/security::rsi-git-patch-self-mod-gate (authoritative)
...
const SECURITY_CMD = 'rsi-git-patch-self-mod-gate';
const bridge = createOpsLaneBridge(__dirname, 'rsi_git_patch_self_mod_gate', 'security-plane');
