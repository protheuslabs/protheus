...
// Layer ownership: core/layer1/security::startup-attestation-boot-gate (authoritative)
...
const SECURITY_CMD = 'startup-attestation-boot-gate';
const bridge = createOpsLaneBridge(__dirname, 'startup_attestation_boot_gate', 'security-plane');
