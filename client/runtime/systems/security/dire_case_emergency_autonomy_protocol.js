...
const SECURITY_CMD = 'dire-case-emergency-autonomy-protocol';
const bridge = createOpsLaneBridge(__dirname, 'dire_case_emergency_autonomy_protocol', 'security-plane');
