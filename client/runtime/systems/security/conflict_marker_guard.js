...
// Layer ownership: core/layer1/security::conflict-marker-guard (authoritative)
...
const SECURITY_CMD = 'conflict-marker-guard';
const bridge = createOpsLaneBridge(__dirname, 'conflict_marker_guard', 'security-plane');
