...
// Layer ownership: core/layer1/security::llm-gateway-guard (authoritative)
...
const SECURITY_CMD = 'llm-gateway-guard';
const bridge = createOpsLaneBridge(__dirname, 'llm_gateway_guard', 'security-plane');
