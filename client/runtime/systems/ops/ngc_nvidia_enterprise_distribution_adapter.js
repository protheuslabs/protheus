...
const LANE_ID = 'SYSTEMS-OPS-NGC-NVIDIA-ENTERPRISE-DISTRIBUTION-ADAPTER';
const bridge = createOpsLaneBridge(__dirname, 'ngc_nvidia_enterprise_distribution_adapter', 'legacy-retired-lane');
