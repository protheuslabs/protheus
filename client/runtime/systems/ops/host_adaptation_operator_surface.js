...
const LANE_ID = 'SYSTEMS-OPS-HOST-ADAPTATION-OPERATOR-SURFACE';
const bridge = createOpsLaneBridge(__dirname, 'host_adaptation_operator_surface', 'legacy-retired-lane');
