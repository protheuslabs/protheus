...
const LANE_ID = 'SYSTEMS-OPS-COMMAND-REGISTRY-SURFACE-CONTRACT';
const bridge = createOpsLaneBridge(__dirname, 'command_registry_surface_contract', 'legacy-retired-lane');
