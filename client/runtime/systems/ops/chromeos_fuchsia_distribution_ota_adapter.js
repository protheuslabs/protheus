...
const LANE_ID = 'SYSTEMS-OPS-CHROMEOS-FUCHSIA-DISTRIBUTION-OTA-ADAPTER';
const bridge = createOpsLaneBridge(__dirname, 'chromeos_fuchsia_distribution_ota_adapter', 'legacy-retired-lane');
