...
const LANE_ID = 'SYSTEMS-OPS-AWS-REPRODUCIBLE-ARTIFACT-PROFILE';
const bridge = createOpsLaneBridge(__dirname, 'aws_reproducible_artifact_profile', 'legacy-retired-lane');
