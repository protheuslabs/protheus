...
const LANE_ID = 'SYSTEMS-OPS-PLATFORM-ADAPTATION-CHANNEL-RUNTIME';
const bridge = createOpsLaneBridge(__dirname, 'platform_adaptation_channel_runtime', 'legacy-retired-lane');
