...
const LANE_ID = 'SYSTEMS-OPS-COMPATIBILITY-CONFORMANCE-PROGRAM';
const bridge = createOpsLaneBridge(__dirname, 'compatibility_conformance_program', 'legacy-retired-lane');
