...
const LANE_ID = 'SYSTEMS-OPS-PROTHEUS-CORE-RUST-BINDING-PLANE';
const bridge = createOpsLaneBridge(__dirname, 'protheus_core_rust_binding_plane', 'legacy-retired-lane');
