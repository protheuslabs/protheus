...
const LANE_ID = 'SYSTEMS-OPS-PINNACLE-INTEGRATION-CONTRACT-CHECK';
const bridge = createOpsLaneBridge(__dirname, 'pinnacle_integration_contract_check', 'legacy-retired-lane');
