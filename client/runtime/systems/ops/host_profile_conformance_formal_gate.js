...
const LANE_ID = 'SYSTEMS-OPS-HOST-PROFILE-CONFORMANCE-FORMAL-GATE';
const bridge = createOpsLaneBridge(__dirname, 'host_profile_conformance_formal_gate', 'legacy-retired-lane');
