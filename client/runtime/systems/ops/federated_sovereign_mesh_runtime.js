...
const LANE_ID = 'SYSTEMS-OPS-FEDERATED-SOVEREIGN-MESH-RUNTIME';
const bridge = createOpsLaneBridge(__dirname, 'federated_sovereign_mesh_runtime', 'legacy-retired-lane');
