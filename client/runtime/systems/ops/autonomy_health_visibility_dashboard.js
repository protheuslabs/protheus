...
const LANE_ID = 'SYSTEMS-OPS-AUTONOMY-HEALTH-VISIBILITY-DASHBOARD';
const bridge = createOpsLaneBridge(__dirname, 'autonomy_health_visibility_dashboard', 'legacy-retired-lane');
