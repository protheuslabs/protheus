...
const LANE_ID = 'SYSTEMS-OPS-RUST-AUTHORITATIVE-MICROKERNEL-ACCELERATION';
const bridge = createOpsLaneBridge(__dirname, 'rust_authoritative_microkernel_acceleration', 'legacy-retired-lane');
