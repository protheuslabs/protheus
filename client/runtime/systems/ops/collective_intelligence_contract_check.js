...
const LANE_ID = 'SYSTEMS-OPS-COLLECTIVE-INTELLIGENCE-CONTRACT-CHECK';
const bridge = createOpsLaneBridge(__dirname, 'collective_intelligence_contract_check', 'legacy-retired-lane');
