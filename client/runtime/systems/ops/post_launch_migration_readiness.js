...
const LANE_ID = 'SYSTEMS-OPS-POST-LAUNCH-MIGRATION-READINESS';
const bridge = createOpsLaneBridge(__dirname, 'post_launch_migration_readiness', 'legacy-retired-lane');
