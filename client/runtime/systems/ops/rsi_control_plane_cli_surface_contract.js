...
const LANE_ID = 'SYSTEMS-OPS-RSI-CONTROL-PLANE-CLI-SURFACE-CONTRACT';
const bridge = createOpsLaneBridge(__dirname, 'rsi_control_plane_cli_surface_contract', 'legacy-retired-lane');
