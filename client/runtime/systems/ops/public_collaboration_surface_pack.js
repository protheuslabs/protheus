...
const LANE_ID = 'SYSTEMS-OPS-PUBLIC-COLLABORATION-SURFACE-PACK';
const bridge = createOpsLaneBridge(__dirname, 'public_collaboration_surface_pack', 'legacy-retired-lane');
