...
const LANE_ID = 'SYSTEMS-OPS-MOBILE-COMPETITIVE-BENCHMARK-MATRIX';
const bridge = createOpsLaneBridge(__dirname, 'mobile_competitive_benchmark_matrix', 'legacy-retired-lane');
