...
const LANE_ID = 'SYSTEMS-OPS-DOCUMENTATION-PROGRAM-HARDENING';
const bridge = createOpsLaneBridge(__dirname, 'documentation_program_hardening', 'legacy-retired-lane');
