...
const LANE_ID = 'SYSTEMS-OPS-CI-WORKFLOW-RATIONALIZATION-CONTRACT';
const bridge = createOpsLaneBridge(__dirname, 'ci_workflow_rationalization_contract', 'legacy-retired-lane');
