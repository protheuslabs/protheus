...
const LANE_ID = 'SYSTEMS-OPS-CROSS-INSTANCE-FEDERATED-LEARNING';
const bridge = createOpsLaneBridge(__dirname, 'cross_instance_federated_learning', 'legacy-retired-lane');
