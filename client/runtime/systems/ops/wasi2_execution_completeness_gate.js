...
const LANE_ID = 'SYSTEMS-OPS-WASI2-EXECUTION-COMPLETENESS-GATE';
const bridge = createOpsLaneBridge(__dirname, 'wasi2_execution_completeness_gate', 'legacy-retired-lane');
