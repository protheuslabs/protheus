...
const LANE_ID = 'SYSTEMS-OPS-ROOT-SCAFFOLDING-RATIONALIZATION';
const bridge = createOpsLaneBridge(__dirname, 'root_scaffolding_rationalization', 'legacy-retired-lane');
