...
const LANE_ID = 'SYSTEMS-OPS-HYBRID-INTERFACE-STABILITY-CONTRACT';
const bridge = createOpsLaneBridge(__dirname, 'hybrid_interface_stability_contract', 'legacy-retired-lane');
