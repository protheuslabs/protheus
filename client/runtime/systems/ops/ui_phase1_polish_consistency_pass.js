...
const LANE_ID = 'SYSTEMS-OPS-UI-PHASE1-POLISH-CONSISTENCY-PASS';
const bridge = createOpsLaneBridge(__dirname, 'ui_phase1_polish_consistency_pass', 'legacy-retired-lane');
