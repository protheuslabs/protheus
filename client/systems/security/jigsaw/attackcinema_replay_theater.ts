...
/**
 * Runtime lane for SYSTEMS-SECURITY-JIGSAW-ATTACKCINEMA-REPLAY-THEATER.
...
const lane = createLaneModule('SYSTEMS-SECURITY-JIGSAW-ATTACKCINEMA-REPLAY-THEATER', ROOT);
