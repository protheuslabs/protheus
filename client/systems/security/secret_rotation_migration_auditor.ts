...
/**
 * Runtime lane for SYSTEMS-SECURITY-SECRET-ROTATION-MIGRATION-AUDITOR.
...
const lane = createLaneModule('SYSTEMS-SECURITY-SECRET-ROTATION-MIGRATION-AUDITOR', ROOT);
