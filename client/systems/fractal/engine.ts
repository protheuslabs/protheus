...
function usage() {
  console.log('Usage:');
  console.log('  node client/systems/fractal/engine.ts run-once [--model=<id>] [--apply-live=0|1] [--max-mutations=N]');
  console.log('  node client/systems/fractal/engine.ts start [--interval-minutes=N] [--apply-live=0|1]');
  console.log('  node client/systems/fractal/engine.ts drills [--apply=0|1]');
  console.log('  node client/systems/fractal/engine.ts status');
}
