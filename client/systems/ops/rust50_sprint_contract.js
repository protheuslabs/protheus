...
function usage() {
    console.log('Usage:');
    console.log('  node client/systems/ops/rust50_sprint_contract.js run --sprint-id=<id> --batch-id=<id> [--plan-file=<path>|--plan-json=<json>] [--proof-refs=a,b] [--blockers=a,b] [--requested-status=in_progress|done] [--approval-recorded=1|0] [--enforcer-active=1|0] [--preamble-text=\"...\"] [--strict=1|0] [--apply=1|0]');
    console.log('  node client/systems/ops/rust50_sprint_contract.js status [--policy=<path>]');
}
