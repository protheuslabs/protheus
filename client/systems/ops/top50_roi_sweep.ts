...
function actionsForToday(): Action[] {
  ...
  return [
    ...
    { roi_rank: 42, id: 'docs_coverage_gate', command: 'node client/systems/ops/docs_coverage_gate.js run --strict=0' },
    { roi_rank: 43, id: 'handoff_pack', command: 'npm run handoff:pack' },
    { roi_rank: 44, id: 'handoff_simulate', command: 'node client/systems/ops/handoff_pack.js simulate --strict=0' },
