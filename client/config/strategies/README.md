...
Purpose: keep specialized objective/risk policy out of `client/systems/` code.
...
- Keep `client/systems/` broadly reusable and strategy-agnostic.
- Keep platform specifics in `client/skills/` and high-churn shortcuts in `client/habits/`.
...
- Strategy lifecycle grading can be generated via:
  - `node client/systems/strategy/strategy_learner.js run [YYYY-MM-DD] --days=14`
