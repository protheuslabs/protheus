...
```bash
node client/systems/observability/siem_bridge.js export --format=otlp
node client/systems/observability/siem_bridge.js export --format=cef
node client/systems/observability/siem_bridge.js correlate --strict=1
node client/systems/observability/siem_bridge.js status
```
