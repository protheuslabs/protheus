...
`client/systems/security/formal_invariant_engine.js` is the machine-checkable invariant lane.

## Spec

Invariant spec file:

- `client/config/formal_invariants.json`
...
node client/systems/security/formal_invariants_bootstrap.js run --strict=1
node client/systems/security/formal_invariant_engine.js status
```
...
- `client/systems/security/merge_guard.ts` runs `formal_invariant_engine.js run --strict=1`
