...
```bash
node client/systems/budget/capital_allocation_organ.js seed --balance=1000
node client/systems/budget/capital_allocation_organ.js simulate --bucket=compute --amount=100 --expected-return=0.2 --risk-score=0.2
node client/systems/budget/capital_allocation_organ.js allocate --bucket=compute --amount=100 --simulation-id=<id> --strict=1
node client/systems/budget/capital_allocation_organ.js settle --allocation-id=<id> --actual-return=0.08
node client/systems/budget/capital_allocation_organ.js evaluate --days=30 --strict=1
```
