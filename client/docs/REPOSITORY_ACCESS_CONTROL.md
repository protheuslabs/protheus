...
- `client/config/repository_access_policy.json`
...
```bash
node client/systems/security/repository_access_auditor.js status --strict=1
node client/systems/security/repository_access_auditor.js status --strict=1 --remote=1
node client/systems/security/repository_access_auditor.js review-plan --apply=1
```
