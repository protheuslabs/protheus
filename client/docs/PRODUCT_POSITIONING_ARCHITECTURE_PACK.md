...
- Governance/runbook:
  ...
  - `client/docs/BRANCH_PROTECTION_POLICY.md`
  - `client/docs/THREAT_MODEL_V1.md`
- Core policy surfaces:
  - `client/config/security_integrity_policy.json`
  - `client/config/workflow_executor_policy.json`
  - `client/config/inversion_policy.json`
  - `client/config/agent_passport_policy.json`
- Runtime audit state:
  - `state/security/`
  - `state/ops/`
