...
| BL-014 | backlog | BL | done | Phased TypeScript migration for `client/systems/` + `client/lib/` |  |
...
| V3-016 | backlog | V3 | done | Central Eye kernel (`client/systems/eye`) with governed subsumption adapters |  |
...
| V3-RACE-068 | extension | V3 | done | Advisory JS Purge Wave (`client/habits/scripts`, `client/memory/tools`) | V2-001, V2-003, BL-014, RM-002 |
...
| V3-RACE-CONF-002 | hardening | V3 | done | Legacy Path Alias Adapters (`client/systems/state/event_stream.js`, `client/systems/autogenesis/*`) | V3-RACE-017, V3-RACE-018 |
...
| V3-RACE-CONF-004 | hardening | V3 | done | Rust Memory Path-Contract Compatibility (`core/memory` alias client/docs/wrappers) | V3-RACE-023, V3-DOC-001 |
