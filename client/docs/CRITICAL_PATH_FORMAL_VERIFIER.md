...
```bash
node client/systems/security/critical_path_formal_verifier.js run --strict=1
node client/systems/security/critical_path_formal_verifier.js status
```

## Policy

Policy file: `client/config/critical_path_formal_policy.json`
