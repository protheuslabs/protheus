...
- Adapter: `client/systems/polyglot/polyglot_service_adapter.ts`
- Worker: `client/systems/polyglot/pilot_task_classifier.py`
- Policy: `client/config/polyglot_service_policy.json`
