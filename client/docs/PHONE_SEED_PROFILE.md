...
```bash
node client/systems/ops/phone_seed_profile.js run
node client/systems/ops/phone_seed_profile.js run --strict=1
node client/systems/ops/phone_seed_profile.js status
```

## Policy

Policy file: `client/config/phone_seed_profile_policy.json`
