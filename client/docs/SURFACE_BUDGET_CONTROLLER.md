...
```bash
node client/systems/hardware/surface_budget_controller.js run
node client/systems/hardware/surface_budget_controller.js run --apply=1 --strict=1
node client/systems/hardware/surface_budget_controller.js status
```

## Policy

Policy file: `client/config/surface_budget_controller_policy.json`
