...
- Acceptance:
  ...
  - [client/docs/GETTING_STARTED.md](../GETTING_STARTED.md) includes one-line install commands.
...
- Acceptance:
  ...
  - [client/docs/GETTING_STARTED.md](../GETTING_STARTED.md) provides a <2 minute path.
...
- Added/updated docs: `ARCHITECTURE.md`, `README.md`, and `client/docs/GETTING_STARTED.md`.
