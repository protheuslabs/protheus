...
- Acceptance:
  - `client/docs/community/GOOD_FIRST_ISSUES.md` exists with 10 scoped issues.
...
- Acceptance:
  - `client/systems/ops/good_first_issue_seed.js` supports dry-run and apply modes.
...
- Acceptance:
  - `client/docs/announcements/INFRING_LAUNCH_TEMPLATE.md` exists with ready-to-post templates.
...
- Acceptance:
  - Human-governed publication of release tags/announcements is tracked in `client/docs/HUMAN_ONLY_ACTIONS.md`.
