...
```bash
node client/systems/hardware/compression_transfer_plane.js compress
node client/systems/hardware/compression_transfer_plane.js expand --bundle-id=<id> --apply=1
node client/systems/hardware/compression_transfer_plane.js auto --target-profile=desktop --apply=1
node client/systems/hardware/compression_transfer_plane.js status
```
...
Policy file: `client/config/compression_transfer_plane_policy.json`
