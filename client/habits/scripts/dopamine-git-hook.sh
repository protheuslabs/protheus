...
# Install: ln -sf /Users/jay/.openclaw/workspace/client/habits/scripts/dopamine-git-hook.sh .git/hooks/post-commit
#

cd /Users/jay/.openclaw/workspace || exit 0

# Run autocap silently (suppress output unless error)
/Users/jay/.local/client/bin/dop autocap git > /dev/null 2>&1
