 ...
 * 
 * Commands:
 *   node client/habits/scripts/sensory_queue.js ingest [YYYY-MM-DD]
 *   node client/habits/scripts/sensory_queue.js list [--status=X] [--days=N]
 *   node client/habits/scripts/sensory_queue.js accept <ID> [--note="..."]
 *   node client/habits/scripts/sensory_queue.js reject <ID> --reason="..."
 *   node client/habits/scripts/sensory_queue.js done <ID> [--note="..."]
 *   node client/habits/scripts/sensory_queue.js snooze <ID> --until=YYYY-MM-DD
 *   node client/habits/scripts/sensory_queue.js stats [--days=N]
 */
